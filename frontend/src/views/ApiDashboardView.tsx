...
export default function ApiDashboardView() {
  ...
  return (
    <div className="min-h-screen p-6">
      ...
      >
        {Object.entries(usageData.providers).map(([provider, stats], index) => (
          <motion.div
            key={provider}
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
              ...
              <div className="space-y-3">
                <div>
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span className="text-sm font-semibold text-white">{stats.daily_requests}</span>
                  </div>
                </div>
                ...
                <div>
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span className="text-sm font-semibold text-white">{stats.total_requests}</span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="w-full bg-gray-700 rounded-full h-2 overflow-hidden">
                    <motion.div
                      ...
                      initial={{ width: 0 }}
                      animate={{ width: `${stats.daily_usage_percent}%` }}
                      transition={{ duration: 0.8, ease: "easeOut" }}
                    />
                  </div>
                  <div className="text-xs text-gray-400 mt-1 text-right">
                    {stats.daily_usage_percent.toFixed(1)}% used
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span className="text-lg font-semibold text-white">
                  {usageData.storage.mongodb.database_size_mb.toFixed(2)} MB
                </span>
              </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-lg font-semibold text-white">
                  {usageData.storage.mongodb.document_count.toLocaleString()}
                </span>
              </div>

              <div className="text-xs text-gray-500">
                Last updated: {new Date(usageData.storage.mongodb.last_updated).toLocaleString()}
              </div>
            </div>
          </div>
        </motion.div>
          ...
          <div className="relative z-10">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span className="text-lg font-semibold text-white">
                  {usageData.storage.pinecone.vector_count.toLocaleString()}
                </span>
              </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-lg font-semibold text-white">
                  {usageData.storage.pinecone.index_fullness_percent.toFixed(1)}%
                </span>
              </div>
              ...
              <div>
                <div className="w-full bg-gray-700 rounded-full h-2 overflow-hidden">
                  <motion.div
                    ...
                    initial={{ width: 0 }}
                    animate={{ width: `${usageData.storage.pinecone.index_fullness_percent}%` }}
                    transition={{ duration: 0.8, ease: "easeOut" }}
                  />
                </div>
              </div>
              ...
              <div className="text-xs text-gray-500">
                Last updated: {new Date(usageData.storage.pinecone.last_updated).toLocaleString()}
              </div>
            </div>
          </div>
        </motion.div>
